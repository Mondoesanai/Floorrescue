...
slides.push(`
  <section class="slide">
    ...
    <div class="three-shots">
      ...
      <figure><div class="shot"><img src="{{IMG_CN0}}" alt="Concrete look: smooth concrete with the text cut into it"></div><figcaption><b>The concrete look</b> &mdash; smooth slab under the hero, text cut into the surface.</figcaption></figure>
      <figure><div class="shot"><img src="{{IMG_CN7}}" alt="Concrete look: deeper slabs with pressed-in photos"></div><figcaption><b>&hellip;and deeper</b> &mdash; every section a different material, as if you&rsquo;re descending beneath the floor.</figcaption></figure>
    </div>
    <p class="lead" style="margin-top:1.1rem;max-width:74ch">Same content, same pages, same speed. It&rsquo;s a switch on the homepage &mdash; tap the small square beside Request a Quote. Love it and we make it the default; don&rsquo;t, and nothing is lost.</p>
  </section>`);
...
const css = `
  ...
  @media (max-width:900px){.cards3,.stats4,.three-shots{grid-template-columns:1fr 1fr}}
</style>`;
